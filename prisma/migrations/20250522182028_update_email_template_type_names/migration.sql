/*
  ...
  - The values [ONBOARDING,OFFBOARDING] on the enum `EmailTemplateType` will be removed. If these variants are still used in the database, this will fail.

*/
-- AlterEnum
BEGIN;
CREATE TYPE "EmailTemplateType_new" AS ENUM ('ACCEPTANCE', 'REJECTION', 'LEAVING');
