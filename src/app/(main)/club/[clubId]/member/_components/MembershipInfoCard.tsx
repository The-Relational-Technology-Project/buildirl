...
import { toDisplayDate, formatBillingInterval } from "~/client/utils";
      ...
      <Stack gap="lg">
        ...
        <SimpleGrid cols={{ base: 1, sm: 2 }} spacing="sm">
          ...
          <Group gap="xs">
            ...
            <Text size="sm">
              {`$${membership.membershipTier.costPerBillingInterval}.00/${formatBillingInterval(membership.membershipTier.billingInterval)}`}
            </Text>
          </Group>
