...
export default class SetMembershipAsWelcomedCommand
  implements Command<SystemState, Services>
{
  ...
  async run(m: SystemState, r: Services): Promise<void> {
    ...
    await r.membership.setMembershipAsWelcomed(this.membershipId);
    m.setMembershipAsWelcomed(this.membershipId);
  ...
  toString() {
    return stringify({
      SetMembershipAsWelcomedCommand: {
